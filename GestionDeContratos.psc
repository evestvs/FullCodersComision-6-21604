...
Funcion MenuParametros
	Borrar Pantalla
	Escribir '------------------------------------------------------------------------------------------------------------'
	Escribir '   1.   Menú Parámetros'
	Escribir '------------------------------------------------------------------------------------------------------------'
	Escribir '   1.1. Clase de contratos'
...
Funcion ContratosAltas (CR Por Referencia)
	...
	Si DatoCorrecto Entonces
		...
		Repetir
			...
			Escribir '(Sin comas, ni puntos, serán eliminados) :' Sin Saltar
			...
			Para Posicion<-1 Hasta LargoImporteIngresado Hacer
...
Funcion ContratosVigentes (CR Por Referencia)
	...
	Para ContratosFilas<-1 Hasta 5 Hacer
